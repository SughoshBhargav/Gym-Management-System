...
public class DeleteTrainer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Delete Trainer");
        ...
        jLabel8.setText("TRAINER_ID :");

        member_id.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(118, 269, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(confirmation){
            ...
            {
                String sql = "Delete from trainer where trainer_id ='" + search_res + "'";
                try {
                    
                    PreparedStatement ps = MyConnection.getConnection().prepareStatement(sql);
                    ps.execute(); 
                    
                    JOptionPane.showMessageDialog(null, "Trainer " + search_res + " Deleted");
                } 
                catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Trainer " + search_res + " not found","Error",JOptionPane.ERROR_MESSAGE);
                }
            }
            this.dispose();
            ...
            JOptionPane.showMessageDialog(rootPane,"Search a trainer","Error",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
       ...
       search_clicked = true;
       String train_id = member_id.getText();
       String sql = "select * from trainer where trainer_id = '"+train_id+"'";
       ...
       GENDERFIELD.setEditable(false);
        ...
        try { 
            ...
            if(rs.next())
            {
                ...
                JOptionPane.showMessageDialog(rootPane, "Trainer Not Found","Error",JOptionPane.ERROR_MESSAGE);
            }
