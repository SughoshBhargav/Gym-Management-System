...
public class ListOfMembers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member_ID", "User ID", "Name", "Contact", "Address", "Gender", "Email", "Plan", "Amount"
            }
        ) {
        ...
        Boolean members_found = false;
             try {   
                ...
                while(rs.next()){
                    ...
                    members_found = true;
                    model.addRow(new String[]{rs.getString(8),rs.getString(9),rs.getString(1),rs.getString(2),rs.getString(4),rs.getString(5),rs.getString(3),rs.getString(6),rs.getString(7)});
                    }    
                
                if(members_found == false){
                    JOptionPane.showMessageDialog(rootPane, "No Members Exists");
                }
