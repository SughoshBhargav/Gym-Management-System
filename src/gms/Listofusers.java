...
public class Listofusers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "Name", "Contact", "Email ID", "Password"
            }
        ) {
        ...
        Boolean users_found = false;
             try {   
                ...
                model.setRowCount(0);
                {
                        while(rs.next()){
                           users_found = true;
                           model.addRow(new String[]{rs.getString(5),rs.getString(1),rs.getString(4),rs.getString(3),rs.getString(2)});
                        }
                }
                if(users_found == false){
                    JOptionPane.showMessageDialog(rootPane, "No users Exists");
                }
